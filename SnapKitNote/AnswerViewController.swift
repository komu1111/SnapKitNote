...
enum QuestionNumber: String {
    ...
    case q3 = "Q3. viewを画面の中央に配置(Q1. と同じ)"
    case q4 = "Q4. 画面サイズのviewを配置"
    case q5 = "Q5. 画面の左下に固定サイズのviewを配置"
    case q6 = "Q6. 画面下に複数のviewを高さ固定で配置"
    case q7 = "Q7. 画面下に複数のviewを縦横比率を固定で配置"
    case q8 = "Q8. 画面中央に画面サイズの60%の幅の画像を配置"
    case q9 = "Q9. 画面の上から画面の縦40%の高さのviewを配置"
    case q10 = "Q10. 画面分割して上の領域の中央にviewを配置"
